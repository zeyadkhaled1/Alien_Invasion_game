...
class AlienInvasion:
    ...
    def _update_aliens(self):
        """Update the posittions of all aliens in the fleet"""
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat the same as if tthe ship got hit.
                self._ship_hit()
                break
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Decrement Ships_left, anddd update scoreboard.
            self.stats.ships_left -= 1
            self.sb.prep_ships()
            # Get rid of any remaining aliens and bullets.
            self.aliens.empty()
            self.bullets.empty()
            # Create a new fleet and center the shipp
            self._create_fleet()
